...
| Module | Schematic |
|---|---|
| `uart_tx` | [`docs/schematics/uart_tx_schematic.png`](docs/schematics/uart_tx_schematic.png) |
| `uart_rx` | [`docs/schematics/uart_rx_schematic.png`](docs/schematics/uart_rx_schematic.png) |
| `UART_top` | [`docs/schematics/uart_top_schematic.png`](docs/schematics/uart_top_schematic.png) |
